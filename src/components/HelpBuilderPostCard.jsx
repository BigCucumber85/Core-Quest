...
function HelpBuilderPostCard({ data,index }) {
  ...
  return (
    <article className="flex flex-col pb-3 bg-white border border-solid border-orange-500 border-opacity-50 max-w-[410px]">
      <img
        ...
        src={
          value?.img_url ||
          "https://cdn.builder.io/api/v1/image/assets/TEMP/30e5ff415a780c58b4ffe218c9c49cd835ccbb3d471f127a52a79f60824d2fdd?apiKey=b93734ecdcb94378af862d5b2ec71620&&apiKey=b93734ecdcb94378af862d5b2ec71620"
        }
        alt=""
      ...
      <header className="flex gap-5 justify-between self-center px-5 mt-1.5 w-full text-black max-w-[424px]">
        <h1 className="my-auto text-xl font-semibold">{value?.project_name}</h1>
      ...
      <footer className="flex gap-5 ml-2 justify-between mt-2">
        <div className="flex gap-5 justify-between items-center">
          <div className="flex flex-col self-stretch my-auto">
            <div className="text-base text-black">{value?.fund_asking || 0} USD</div>
        ...
        <div className="flex gap-2">
          ...
          <div className="flex flex-col px-5 my-auto">
            <div className="text-base text-black">{value?.team_name || `Team #Builders`}</div>
